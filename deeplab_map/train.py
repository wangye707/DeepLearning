...
class args:
    ...
    test_image_path = 'dataset/train/image/image_4/image_20_18600_13800.jpg'
    test_label_path = 'dataset/train/label/label_4/image_10_41400_3600.png'
...
image = tf.placeholder(tf.float32, [None, 1200, 1200, 3], name='input_x')
label = tf.placeholder(tf.int32, [None, 1200, 1200])
    ...
    for step in range(1, 50001):
        ...
        loss_tr, l2_loss_tr, predicts_tr, _ = sess.run(
            ...
            feed_dict={
                ...
                lr: learning_rate})
        print(step,loss_tr,l2_loss_tr,predicts_tr)
